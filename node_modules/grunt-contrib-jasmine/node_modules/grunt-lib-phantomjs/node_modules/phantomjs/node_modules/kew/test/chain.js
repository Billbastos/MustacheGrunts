...
// spec that fin() works with a synchronous resolve
...
// spec that fin() works with a synchronous reject
...
// spec that fin() works with an asynchrnous resolve
...
// spec that fin() works with an asynchronous reject
...
// spec that we can call end without callbacks and not fail
...
// spec that we can call end with callbacks and fail
...
// spec chaining when a promise returns a promise
...
// spec .end() is called with no parent scope (causing an uncaught exception)
...
// spec .end() is called with a parent scope and is caught
