...
describe('Browser', function () {
    ...
    describe('#parseAuthorizationHeader', function (done) {
        ...
        it('returns null on bad attribute value', function (done) {
            ...
            expect(Browser.utils.parseAuthorizationHeader('Hawk spec="\t"', ['test'])).to.equal(null);
            done();
        });

        it('returns null on duplicated attribute', function (done) {

            expect(Browser.utils.parseAuthorizationHeader('Hawk spec="a", spec="b"', ['test'])).to.equal(null);
            done();
        });
    });
