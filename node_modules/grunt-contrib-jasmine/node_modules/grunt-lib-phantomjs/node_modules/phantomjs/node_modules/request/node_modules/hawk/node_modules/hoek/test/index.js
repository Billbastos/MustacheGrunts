...
describe('Hoek', function () {
    ...
    describe('#displayStack ', function () {
        ...
        it('should return the full call stack for display', function (done) {
            ...
            expect(stack[0]).to.contain('spec/index.js:');
            done();
        });
    ...
    describe('#abort', function () {
        ...
        it('should exit process when not in spec mode', function (done) {
        ...
        it('should throw when not in spec mode and abortThrow is true', function (done) {
    ...
    describe('#assert', function () {
        ...
        it('should throw an Error when using assert in a spec', function (done) {
        ...
        it('should throw an Error when using assert in a spec with no message', function (done) {
        ...
        it('should throw an Error when using assert in a spec with multipart message', function (done) {
        ...
        it('should throw an Error when using assert in a spec with object message', function (done) {
        ...
        it('should throw an Error when using assert in a spec with error object message', function (done) {
    ...
    describe('#escapeHeaderAttribute', function () {
        ...
        it('should throw on large unicode characters', function (done) {
            ...
            var fn = function () {
                ...
                Hoek.escapeHeaderAttribute('this is a spec' + String.fromCharCode(500) + String.fromCharCode(300));
            };
        ...
        it('should throw on CRLF to prevent response splitting', function (done) {
            ...
            var fn = function () {
                ...
                Hoek.escapeHeaderAttribute('this is a spec\r\n');
            };
