...
describe('Array', function () {
    ...
    describe('indexOf', function () {
        ...
        it('should use a strict spec', function () {
        ...
        describe('Array-like', function ArrayLike() {
            ...
            it('should use a strict spec (array-like)', function () {
    ...
    describe('splice', function () {
        ...
        /* This spec is disabled, because ES6 normalizes actual
        ...
        it('basic implementation spec 1', function () {
            expect(test.splice(0, 0)).toEqual([]);
        });

        it('basic implementation spec 2', function () {
            test.splice(0, 2);
        ...
        it('should not break on sparse arrays in Opera', function () {
            // spec from https://github.com/wikimedia/VisualEditor/blob/d468b00311e69c2095b9da360c5745153342a5c3/src/ve.utils.js#L182-L196
            var n = 256;
            var arr = [];
            arr[n] = 'a';
            arr.splice(n + 1, 0, 'b');
