...
{
  // 'custom 2': function () {
  //   return custom(spec, 2, 0)
  // },
  // 'customWs 2': function () {
  //   return customWs(spec, 2, 0)
  // },
  ...
  //   return util.inspect(spec, false, 1, false)
  // },
  // 'util.inspect undefined': function () {
  //   util.inspect(spec)
  // },
  // 'util.inspect 2': function () {
  //   util.inspect(spec, false, 2, false)
  // },
  // 'util.inspect 3': function () {
  //   util.inspect(spec, false, 3, false)
  // },
  // 'util.inspect 4': function () {
  //   util.inspect(spec, false, 4, false)
  // },
  // 'util.inspect Infinity': function () {
  //   util.inspect(spec, false, Infinity, false)
  // }
}
