...
var encodingStrings = {
    'windows-1251': 'This is a spec string 32 chars..',
    'gbk':          '这是中文字符测试。。！@￥%12',
    'utf8': '这是中文字符测试。。！@￥%12This is a spec string 48 chars..',
};
// Test encoding.
var str = encodingStrings[encoding];
if (!str) {
    throw new Error('Don\'t support ' + encoding + ' performance spec.');
}
for (var i = 0; i < 13; i++) {
    str = str + str;
}

console.log('\n' + encoding + ' charset performance spec:');
