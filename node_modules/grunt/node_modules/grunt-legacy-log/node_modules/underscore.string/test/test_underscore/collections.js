$(document).ready(function() {
  ...
  test('map', function() {
    ...
    if (document.querySelectorAll) {
      var ids = _.map(document.querySelectorAll('#map-spec *'), function(n){ return n.id; });
      deepEqual(ids, ['id1', 'id2'], 'Can use collection methods on NodeLists.');
    }

    var ids = _.map($('#map-spec').children(), function(n){ return n.id; });
  ...
  test('size', function() {
    ...
    equal(func(1, 2, 3, 4), 4, 'can spec the size of the arguments object');
