...
/**
 * A spec is considered slow if it
...
function HTML(runner) {
  ...
  runner.on('fail', function(test, err){
    if ('hook' == test.type || err.uncaught) runner.emit('spec end', test);
  });
  ...
  runner.on('spec end', function(test){
    ...
    if ('passed' == test.state) {
      var el = fragment('<div class="spec pass %e"><h2>%e<span class="duration">%ems</span></h2></div>', test.speed, test.title, test.duration);
    } else if (test.pending) {
      var el = fragment('<div class="spec pass pending"><h2>%e</h2></div>', test.title);
    } else {
      var el = fragment('<div class="spec fail"><h2>%e</h2></div>', test.title);
