...
function report(run) {
  ...
  jQuery('#qunit-tests > .fail').each(function(i, el) {
    el = jQuery(el);
    console.log(el.find('.spec-name').text());
    el.find('> ol > .fail', this).each(function(i, el) {
      el = jQuery(el);
      console.log('\t' + el.find('.spec-message').text());
      console.log('\t\t' + el.find('.spec-expected').text());
      console.log('\t\t' + el.find('.spec-actual').text());
      console.log('\t\t' + el.find('.spec-source').text());
    });
  });
