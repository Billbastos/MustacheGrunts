...
exports.info = "Nested spec reporter";
...
exports.run = function (files, options, callback) {
    ...
    var tracker = track.createTracker(function (tracker) {
        ...
        if (tracker.unfinished()) {
            ...
            console.log('');
            console.log('To fix this, make sure all tests call spec.done()');
    ...
    /**
     * Prints (console.log) the nested spec status line(s).
     *
    ...
    nodeunit.runFiles(paths, {
        ...
        testDone: function (name, assertions) {
            ...
            if (callback) callback(assertions.failures() ? new Error('We have got spec failures.') : undefined);
        },
