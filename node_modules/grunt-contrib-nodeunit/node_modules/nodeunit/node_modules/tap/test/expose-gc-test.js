...
tap.test("gc spec when the gc isn't there", function (t) {
  console.error("gc spec")
  t.plan(1)
...
tap.test("gc spec when the gc should be there", function (t) {
  console.error("gc spec")
  t.plan(2)
  console.error("t.plan="+t._plan)

  t.test("spec for gc using --gc", function (t) {
    console.error("gc spec using --gc")
    t.plan(1)
    console.error("t.plan="+t._plan)
  ...
  t.test("spec for gc using --expose-gc", function (t) {
    console.error("gc spec using --expose-gc")
    t.plan(1)
    console.error("t.plan="+t._plan)
