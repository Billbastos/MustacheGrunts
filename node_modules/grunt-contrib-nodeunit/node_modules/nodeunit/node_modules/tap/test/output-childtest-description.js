var tap  =  require("../")
  ...
  , nestedTests = 
      ...
      , "test('parent spec description', function (t) {"
      , " t.plan(2)"
      , " t.ok(true, 'spec in parent')"
      , " t.test('child spec description', function (t) {"
      , "    t.plan(1)"
      , "    t.ok(true, 'spec in child')  "
      , " })"
      , "})"
      ].join("\n")
...
tap.test("nested tests, parent and child pass", function (t) {
  ...
  cp.exec("node " + nestedTestsFile, function (err, stdo, stde) {
    var lines = stdo.split("\n")
      , parentDes =  lines.indexOf("# parent spec description")
      , parentRes =  lines.indexOf("ok 1 spec in parent")
      , childDes  =  lines.indexOf("# child spec description")
      , childRes  =  lines.indexOf("ok 2 spec in child")
