...
test('exit code 1 when tap results show failure', function (t) {
  ...
  t.test('spec exits 0, has failures', function (t) {
    t.plan(2)
  ...
  t.test('spec exits 1, has failures', function (t) {
    t.plan(2)
  ...
  t.test('spec exits 1, has no failures', function (t) {
    t.plan(2)
...
test('successes exit 0', function (t) {
  ...
  t.test('spec that does nothing, but exits 0', function (t) {
    t.plan(2)
  ...
  t.test('spec that succeeds, and exits 0', function (t) {
    t.plan(2)
