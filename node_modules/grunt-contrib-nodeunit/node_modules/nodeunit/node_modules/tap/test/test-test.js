...
test("testing the spec object", function (t) {

  t.isa(t, Test, "spec object should be instanceof Test")
  t.isa(t, Harness, "spec object should be instanceof Harness")
  t.is(t._Test, Test, "test._Test should be the Test class")

  // now spec all the methods.
  ; [ "isNotDeepEqual"
    , "equals"
    , "inequivalent"
    , "threw"
