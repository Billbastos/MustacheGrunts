    ...
    nodeunit.runModule('testmodule', testmodule, {
        ...
        testStart: function (name) {
            ...
            test.ok(
                ...
                name.toString() === 'test2' ||
                name.toString() === 'test3',
                'testStart called with spec name '
            );
        },
        testReady: function (tst) {
            call_order.push('testReady');
            test.ok(tst.done, 'testReady called with non-spec object');
            test.ok(tst.ok, 'testReady called with non-spec object');
            test.ok(tst.same, 'testReady called with non-spec object');
            test.ok(tst.expect, 'testReady called with non-spec object');
            test.ok(tst._assertion_list, 'testReady called with non-spec object');
            test.ok(tst.AssertionError, 'testReady called with non-spec object');
            test.ok(tst.fail, 'testReady called with non-spec object');
            test.ok(tst.equal, 'testReady called with non-spec object');
            test.ok(tst.notEqual, 'testReady called with non-spec object');
            test.ok(tst.deepEqual, 'testReady called with non-spec object');
            test.ok(tst.notDeepEqual, 'testReady called with non-spec object');
            test.ok(tst.strictEqual, 'testReady called with non-spec object');
            test.ok(tst.notStrictEqual, 'testReady called with non-spec object');
            test.ok(tst.throws, 'testReady called with non-spec object');
            test.ok(tst.doesNotThrow, 'testReady called with non-spec object');
            test.ok(tst.ifError, 'testReady called with non-spec object');
        },
        testDone: function (name, assertions) {
            ...
            test.ok(
                ...
                name.toString() === 'test2' ||
                name.toString() === 'test3',
                'testDone called with spec name'
            );
        },
