...
function performBasicChecks(betterErrorString) {
    ...
    betterErrorString.should.include("spec-bettererrors");
    //betterErrorString.should.not.include("undefined");
}

/**
 * Control spec. Provide an AssertionError that contains actual, expected operator values.
 * @param test the spec object from nodeunit
 */
 ...
 * will show up in the stack trace and the spec will fail!
 * @param test the spec object from nodeunit
 */
exports.testErrorIsNotAssertion = function (test) {
    try {
        ...
        betterErrorString.should.include("spec error");
        betterErrorString.should.include("spec-bettererrors");
        betterErrorString.should.not.include("undefined");
        test.done();
    }
