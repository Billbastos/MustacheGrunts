...
exports.catchSetUpError = function (test) {
    test.expect(2);
    var test_error = new Error('spec error');
    var s = testCase({
        setUp: function (callback) {
            throw test_error;
        },
        test: function (t) {
            test.ok(false, 'spec function should not be called');
            t.done();
        }
    });
...
exports.testErrorAndtearDownError = function (test) {
    test.expect(3);
    var error1 = new Error('spec error one');
    var error2 = new Error('spec error two');
    var s = testCase({
        tearDown: function (callback) {
            callback(error2);
        },
